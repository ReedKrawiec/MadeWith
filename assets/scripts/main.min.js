...
/***/ function(module, exports, __webpack_require__) {
	...
	var httpGet = function httpGet(theUrl, callback) {
	...
	httpGet("http://localhost:8080/projects.json", function (data) {
	    ...
	    computed: {
	      filterEntries: function filterEntries() {
	        ...
	        entries.forEach(function (entry, index) {
	          var passed_bool = false;
	          if (entry.name.toLowerCase().indexOf(_this.search_string) > -1) passed_bool = true;
	
	          if (entry.lang.toLowerCase().indexOf(_this.search_string) > -1) passed_bool = true;
	          if (entry.author.toLowerCase().indexOf(_this.search_string) > -1) passed_bool = true;
	          entry.tags.forEach(function (tag) {
	            if (tag.toLowerCase().indexOf(_this.search_string) > -1) passed_bool = true;
	          });
	          if (passed_bool) entries_passed.push(entries[index]);
	        });
	        return entries_passed;
	      }
	    },
	    methods: {
	      setString: function setString(e) {
